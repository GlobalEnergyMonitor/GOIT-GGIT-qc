...
[`convert-ggit-goit-to-tracker-release-downloads-CURRENT.ipynb`](convert-ggit-goit-to-tracker-release-downloads-CURRENT.ipynb)
...
- `gem-tracker-constants` (pinned in the notebook's first cell) — single
  source of truth for fuel buckets and status orderings, shared with the
  QC summary sheets in this repo so release totals match QC summary totals
