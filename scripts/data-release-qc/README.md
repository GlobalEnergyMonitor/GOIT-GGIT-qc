...
export notebook in `scripts/data-file-creation/`
...
- **Copyright**: names the right tracker and release month/year, and the
  ...
  it dangling — that's a fix in the `scripts/data-file-creation` export notebook).
...
| Creation date, placeholder conventions, sheet assembly | Export notebook in `scripts/data-file-creation/` |
